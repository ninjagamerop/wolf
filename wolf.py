...
# ===========================================================
#        @HYDRAGAMINGOP @SANJUCOOLZ BOT SCRIPT
# ===========================================================
...
bot = telebot.TeleBot('7564327801:AAGbIS4Cil_T5fUFlCPl3_Wtb9NdA-MvBHo')

# Insert your admin id here
admin_id = ["1514743120", "6874503446", "1240179115"]
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "⛔️ 𝗔𝗰𝗰𝗲𝘀𝘀 𝗗𝗲𝗻𝗶𝗲𝗱: 𝗔𝗱𝗺𝗶𝗻 𝗼𝗻𝗹𝘆 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 DM TO BUY @HYDRAGAMINGOP @SANJUCOOLZ"
        bot.reply_to(message, response)
...
def status_command(message):
    ...
    if user_id in admin_id:
        ...
        bot.reply_to(message, "⛔️ 𝗬𝗼𝘂 𝗮𝗿𝗲 𝗻𝗼𝘁 𝗮𝗻 𝗮𝗱𝗺𝗶𝗻 @HYDRAGAMINGOP @SANJUCOOLZ.")
...
def upload_to_terminal(message):
    """Handle file upload to terminal for admins @HYDRAGAMINGOP @SANJUCOOLZ."""
    user_id = str(message.chat.id)
...
def add_user_command(message):
    if str(message.chat.id) not in admin_id:
        bot.reply_to(message, "⛔ 𝗔𝗰𝗰𝗲𝘀𝘀 𝗗𝗲𝗻𝗶𝗲𝗱: 𝗔𝗱𝗺𝗶𝗻 𝗼𝗻𝗹𝘆 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 DM TO BUY @HYDRAGAMINGOP @SANJUCOOLZ DM TO BUY @HYDRAGAMINGOP @SANJUCOOLZ")
        return
...
def show_modify_options(message):
    if str(message.chat.id) not in admin_id:
        bot.reply_to(message, "⛔ 𝗔𝗰𝗰𝗲𝘀𝘀 𝗗𝗲𝗻𝗶𝗲𝗱: 𝗔𝗱𝗺𝗶𝗻 𝗼𝗻𝗹𝘆 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 DM TO BUY @HYDRAGAMINGOP @SANJUCOOLZ")
        return
